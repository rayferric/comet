...
public class PhysicsBody extends PhysicsObject {
    ...
    private final AtomicFloat friction = new AtomicFloat(0.75F);
    private final AtomicFloat bounce = new AtomicFloat(0);
    private final AtomicFloat linearDrag = new AtomicFloat(0.5F);
    private final AtomicFloat angularDrag = new AtomicFloat(0.05F);
