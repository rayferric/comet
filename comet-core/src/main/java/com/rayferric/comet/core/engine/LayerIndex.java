...
import com.rayferric.comet.core.scenegraph.node.light.DirectionalLight;
import com.rayferric.comet.core.scenegraph.node.light.PointLight;
import com.rayferric.comet.core.scenegraph.node.light.SpotLight;
...
public class LayerIndex {
    ...
    /**
     * Adds a {@link PhysicsObject} to the index.<br>
     * • Is implicitly called by the constructor when traversing the node tree.<br>
     * • Must not be called by the user, this is an internal method.<br>
     * • May be called from any thread.
     *
     * @param obj the {@link PhysicsObject} to be indexed
     */
