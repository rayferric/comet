...
import com.rayferric.comet.core.scenegraph.node.camera.PerspectiveCamera;
...
import com.rayferric.comet.core.scenegraph.resource.physics.shape.CylinderCollisionShape;
...
public class PlayerPack implements NodePack {
    ...
    public Node instantiate() {
...

        {
            ...
            PerspectiveCamera child = new PerspectiveCamera(0.01F, 1000F, 70F);
