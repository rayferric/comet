...
public class GLTexture2D extends GLTexture {
    public GLTexture2D(ByteBuffer data, Vector2i size, TextureFormat format, TextureFilter filter) {
        ...
        switch(filter) {
            ...
            case TRILINEAR: minFilter = GL_LINEAR_MIPMAP_LINEAR; magFilter = GL_LINEAR;  break;
        }
        ...
        switch(format) {
            ...
            case R32F:    compressed = false; internalFormat = GL_R32F;                               baseFormat = GL_RED;  type = GL_FLOAT;         break;
            case RG8:     compressed = false; internalFormat = GL_RG8;                                baseFormat = GL_RG;   type = GL_UNSIGNED_BYTE; break;
            case RG16F:   compressed = false; internalFormat = GL_RG16F;                              baseFormat = GL_RG;   type = GL_HALF_FLOAT;    break;
            case RG32F:   compressed = false; internalFormat = GL_RG32F;                              baseFormat = GL_RG;   type = GL_FLOAT;         break;
            case RGB8:    compressed = false; internalFormat = GL_RGB8;                               baseFormat = GL_RGB;  type = GL_UNSIGNED_BYTE; break;
            case RGB16F:  compressed = false; internalFormat = GL_RGB16F;                             baseFormat = GL_RGB;  type = GL_HALF_FLOAT;    break;
            case RGB32F:  compressed = false; internalFormat = GL_RGB32F;                             baseFormat = GL_RGB;  type = GL_FLOAT;         break;
            case RGBA8:   compressed = false; internalFormat = GL_RGBA8;                              baseFormat = GL_RGBA; type = GL_UNSIGNED_BYTE; break;
            case RGBA16F: compressed = false; internalFormat = GL_RGBA16F;                            baseFormat = GL_RGBA; type = GL_HALF_FLOAT;    break;
            ...
            case BC7:     compressed = true;  internalFormat = GL_COMPRESSED_RGBA_BPTC_UNORM;         baseFormat = GL_RGBA; type = GL_UNSIGNED_BYTE; break;
        }
