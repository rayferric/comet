...
public class Mathf {
    ...
    public static float sin(float x) { return (float)Math.sin(Math.toRadians(x)); }
    public static float cos(float x) { return (float)Math.cos(Math.toRadians(x)); }
    public static float tan(float x) { return (float)Math.tan(Math.toRadians(x)); }
    ...
    public static float atan2(float x, float y) { return (float)Math.toDegrees(Math.atan2(x, y)); }
    ...
    public static float lerp(float x, float y, float weight) { return x + (y - x) * weight; }
}
